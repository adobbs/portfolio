    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <nav className="flex flex-row justify-center mb-20">
                <Link className="hover:text-[#aaff80] underline underline-offset-2 text-base font-light mr-8" 
                    href="/">Home</Link>
                <a className="hover:text-[#aaff80] underline underline-offset-2 text-base font-light mr-8" 
                    href="/AndyDobbsResume.pdf" target="_blank">Resume</a>
                <a className="hover:text-[#aaff80] underline underline-offset-2 text-base font-light mr-8" 
                    href="https://www.linkedin.com/in/dobbs/" target="_blank">LinkedIn</a>
                <a className="hover:text-[#aaff80] underline underline-offset-2 text-base font-light" 
