                    ...
                    <div className="flex flex-col self-start ml-24 max-w-2xl">
                        ...
                        <section className="mb-12">
                            ...
                            <Image
                                ...
                                priority
                            />
                            <p className="text-zinc-400 text-base mb-2">The overall business goal for the Virgin Pulse health and wellbeing platform is to drive population health outcomes for employers (buyers) by improving personal health among employees (users).</p>
                            <p className="text-zinc-400 text-base mb-2">VP IQ is an iOS, Android, and web experience that delivers on this goal by helping people improve health outcomes through personalized interactions powered by artificial intelligence, behavioral science, and machine learning.</p>
                            <p className="text-zinc-400 text-base mb-2">The conversational experience adapts to signals of motivation and demotivation, then explores the underlying reason behind the change before prompting action or delivering content that is ranked by an ML algorithm. This includes all users in an intelligent feedback loop that helps guide them to the next best healthy action.</p>
                            <p className="text-zinc-400 text-base mb-2">In addition to leading design on this feature, I led design of personalization and recommendation features for Virgin Pulse, a platform that reaches 14 million people and spans 22 languages. I created and socialized the design strategy for personalization that informs the work of a global 60 person product organization and 22 engineering teams.</p>
                            <p className="text-zinc-400 text-base mb-2">I also contributed UX research, content strategy, and UX writing work on this feature, and I brought in content and research specialists as early as I could to work side-by-side with design, product management, and engineering. Bringing everyone together helped our team maximize the quality of our vision and the excellence of our execution.</p>
                        </section>
                        <section className="mb-12">
                        ...
                        <section className="mb-12">
                            ...
                            <Image
                                ...
                                priority
                            />
                            <p className="text-zinc-400 text-base mb-2">We focused on a central question to guide our ideation: How might we personalize the health journey in a way that improves outcomes?</p>
                            <p className="text-zinc-400 text-base mb-2">Inspired by cross-functional exploration, we harmonized around a dynamic set of conversational experiences that are triggered through statistical tests of validated health data.</p>
                            <p className="text-zinc-400 text-base mb-2">Two of these experiences, Interventions and Reflections, lead to a choose-your-own-adventure interaction that curates subsets of recommended content based on the reason people provide for why their data has trended in a positive or negative direction.</p>
                            <p className="text-zinc-400 text-base mb-2">Guided by governance rules, people may also receive an experience that helps them set their goals or receive a simple positivity booster called a Celebration.</p>
                            <p className="text-zinc-400 text-base mb-2">Most of the content in this experience is dynamic, and all the copy is served from a custom CMS we built for our content team. The CMS also stores translations in 22 different languages.</p>
                            <p className="text-zinc-400 text-base mb-2">A variety of UX research studies conducted throughout the lifecycle of product discovery and delivery informed the solution every step of the way, helping us refine our approach. The biggest takeaways from that research are that agency increases trust, conversations create comfort, and exploring the root cause is essential.</p>
                        </section>
                        <section>
                            ...
                            <Image
                                ...
                                priority
                            />
                            <p className="text-zinc-400 text-base mb-2">Personalization is a broad topic that extends beyond the idea of curated ML recommendations. To help convey what we learned and help other designers and product teams build off that knowledge, I created and shared research-validated design principles for personalization used by the entire product organization.</p>
                            <p className="text-zinc-400 text-base mb-2">The design, technical, and strategic foundations of this feature were used by many teams to improve how the platform drives impact across the product experience. As detailed in the introduction above, I led design of personalization across the organization, doing hands-on work with one engineering team and consulting with many teams across a global market leader.</p>
                            <p className="text-zinc-400 text-base mb-2">Data gathered through UX research showed that personalization features like VP IQ that I designed are a key driver of behavior change and satisfaction. 87% of users said Virgin Pulse changed their lives, and our NPS score was above 50. VP IQ, the signature personalization feature in the platform, even received a virtual standing ovation from our client success and growth teams due to its ability to help them tell an innovation and engagement story that drives revenue and health outcomes.</p>
                        </section>
                    </div>
                </div>
            </div>
